            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    <div class="relative">
                        ...
                        <div class="hidden absolute right-0 top-full mt-1 w-44 bg-surface-0 border border-surface-200 rounded-lg shadow-lg z-50 overflow-hidden">
                            <a routerLink="/profile" class="flex items-center gap-2 px-4 py-3 text-sm hover:bg-surface-100 cursor-pointer no-underline text-color">
                                <i class="pi pi-id-card text-color-secondary"></i>
                                <span>My Profile</span>
                            </a>
                            <hr class="m-0 border-surface-200">
                            <button type="button" (click)="auth.logout()"
                                class="w-full flex items-center gap-2 px-4 py-3 text-sm hover:bg-surface-100 cursor-pointer border-none bg-transparent text-left text-color">
